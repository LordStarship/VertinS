<x-layout>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <img src="https://media.istockphoto.com/id/1311934969/id/foto/hubungi.jpg?s=612x612&w=0&k=20&c=neex6YDh4xgb3niPEIbNfcT7gPhX2mZ-VhR345ICoNE=" alt="" class="absolute inset-0 -z-10 size-full object-cover object-right md:object-center">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Our Contact</h2>
          <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
            Contact Us to provides key communication channels, including email, phone number, and a contact form, making it easy for customers to reach out for inquiries, support, feedback, or assistance with any concerns.</p>
        </div>
        <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            <div class="flex flex-col-reverse gap-1">
              <dt class="text-base/7 text-gray-300">Account Sold</dt>
              <dd class="text-4xl font-semibold tracking-tight text-white">100+</dd>
            </div>
            <div class="flex flex-col-reverse gap-1">
              <dt class="text-base/7 text-gray-300">Full Time Operational</dt>
              <dd class="text-4xl font-semibold tracking-tight text-white">24 Hours</dd>
            </div>
            {{-- div class="flex flex-col-reverse gap-1">
